 ...
 *
 * Output: plugins/themes.generated.js  (array of [id, name, scheme, [14 hex…]])
 *
...
const md = readFileSync(join(ROOT, 'themes.md'), 'utf8')
...
${named.join(',\n')}]
`
mkdirSync(dirname(join(ROOT, 'plugins/themes.generated.js')), { recursive: true })
writeFileSync(join(ROOT, 'plugins/themes.generated.js'), out)
